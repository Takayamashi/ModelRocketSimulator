...
def q0_0(theta):
    return np.array([np.cos(np.pi * theta / 360.), 0., np.sin(np.pi * theta / 360.), 0.])


def q0_45(theta):
    return np.array([np.cos(np.pi * theta / 360.), - np.sqrt(2) * np.sin(np.pi * theta / 360.) / 2.,
                     np.sqrt(2) * np.sin(np.pi * theta / 360.) / 2., 0.])


def q0_90(theta):
    return np.array([np.cos(np.pi * theta / 360.),
                     - np.sin(np.pi * theta / 360.), 0., 0.])
...
def q0_180(theta):
    return np.array([np.cos(np.pi * theta / 360.), 0.,
                     - np.sin(np.pi * theta / 360.), 0.])
